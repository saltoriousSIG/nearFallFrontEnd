...
const Crew = () => {
    return (
        <GlobalStyle.Container className=' pt-4'>
            <GlobalStyle.Title>The NearFall Crew</GlobalStyle.Title>
            <GlobalStyle.Text className='ps-5 pe-5 ms-5 me-5 pb-5 pt-3'>You can’t have a successful fishing boat without a dedicated and friendly crew. We pride ourselves on making your experience enjoyable and sending you home feeling like you are a part of the Nearfall family. The Nearfall Team is loaded with experience and ready to bring you the best fishing experience on every trip. Each Captain and Deckhand’s knowledge of fishing and the local fishing will not only make your day easier and maximize your time at the rail, but you will also leave your charter as a better fisherman. We all look forward to having you aboard!
            </GlobalStyle.Text>

            <BackDrop className='mb-5'>
                <Image src={captainJoe} />
                <GlobalStyle.Container>
                <GlobalStyle.Title style={{ color: 'white' }} className='pb-1'>
                    Captain Joe Paton
                </GlobalStyle.Title>
                <GlobalStyle.TextNormal className='pb-5'>
                    US Coast Guard Licensed 100 Ton Master Captain
                </GlobalStyle.TextNormal>
                <GlobalStyle.TextNormal className='ps-3 pe-3'>
            ...
            <GlobalStyle.Text className='ps-5 pe-5 ms-5 me-5 pb-5 pt-3'>
