    ...
    <Container>
      ...
      <VesselRow>
        <VesselCol>
          ...
          <CarouselComponent items={donelleSpecs} height={250} interval={5000} />
        </VesselCol>
